...
/**
 * Amfphp_Core_Header is a data type that represents a single header passed via Amf
 *
 * @package Amfphp_Core_Amf
 */

class Amfphp_Core_Header
{
	/**
	...
	/**
	 * Amfphp_Core_Header is the Constructor function for the Amfphp_Core_Header data type.
	 */
