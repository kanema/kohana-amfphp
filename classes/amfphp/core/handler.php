...
class Amfphp_Core_Handler {
    ...
    private $objectEncoding = Amfphp_Core_Constants::AMF0_ENCODING;
    ...
    public function deserialize(array $getData, array $postData, $rawPostData) {
        $deserializer = new Amfphp_Core_Deserializer($rawPostData);
    ...
    /**
     * creates a ServiceCallParamaeters object from an Amfphp_Core_Message
     * supported separators in the targetUri are "/" and "."
     * @param Amfphp_Core_Message $Amfphp_Core_Message
     * @return Amfphp_Core_Common_ServiceCallParameters
     */
    private function getServiceCallParameters(Amfphp_Core_Message $Amfphp_Core_Message) {
        $targetUri = str_replace(".", "/", $Amfphp_Core_Message->targetUri);
        ...
        $ret->methodParameters = $Amfphp_Core_Message->data;
        return $ret;
    }
     ...
     *
     * @param Amfphp_Core_Message $requestMessage
     * @return Amfphp_Core_Message the response Message for the request
     */
    private function handleRequestMessage(Amfphp_Core_Message $requestMessage, Amfphp_Core_Common_ServiceRouter $serviceRouter) {
        ...
        //plugins didn't do any special handling. Assumes this is a simple Amfphp_Core_ RPC call
        ...
        $responseMessage = new Amfphp_Core_Message();
        $responseMessage->data = $ret;
        $responseMessage->targetUri = $requestMessage->responseUri . Amfphp_Core_Constants::CLIENT_SUCCESS_METHOD;
        //not specified
    ...
    public function handleDeserializedRequest($deserializedRequest, Amfphp_Core_Common_ServiceRouter $serviceRouter) {
        ...
        $rawOutputData = "";
        $responsePacket = new Amfphp_Core_Packet();
    ...
    public function handleException(Exception $exception) {
        $errorPacket = new Amfphp_Core_Packet();
        $filterManager = Amfphp_Core_FilterManager::getInstance();
        ...
        $errorResponseMessage = new Amfphp_Core_Message();
        $errorResponseMessage->targetUri = $this->lastRequestMessageResponseUri . Amfphp_Core_Constants::CLIENT_FAILURE_METHOD;
        //not specified
    ...
    public function serialize($data) {
        ...
        $serializer = new Amfphp_Core_Serializer($data);
