...
class Amfphp_Core_Util {
     ...
     * @param bool $ignoreAmfTypes ignore objects with type in Amfphp_Core_Types package. could maybe be replaced by a regexp, but this is better for performance
    ...
    static public function applyFunctionToContainedObjects($obj, $callBack, $recursionDepth = 0, $maxRecursionDepth = 30, $ignoreAmfTypes = true) {
        if ($recursionDepth == $maxRecursionDepth) {
            throw new Kohana_Exception("couldn't recurse deeper on object. Probably a looped reference");
        }
        //don't apply to Amfphp types such as byte array
        if($ignoreAmfTypes && is_object($obj) && substr(get_class($obj),0, 21) == "Amfphp_Core_Types" ){
            return $obj;
        }
    ...
    static public function is_undefined($obj) {
        return is_object($obj) ? get_class($obj) == "Amfphp_Core_Types_Undefined" : false;
    }
    ...
    static public function is_byteArray($obj) {
        return is_object($obj) ? get_class($obj) == "Amfphp_Core_Types_ByteArray" : false;
    }
    ...
    static public function is_date($obj) {
        return is_object($obj) ? get_class($obj) == "Amfphp_Core_Types_Date" : false;
    }
    ...
    static public function is_Xml($obj) {
        return is_object($obj) ? get_class($obj) == "Amfphp_Core_Types_Xml" : false;
    }
        /**
    ...
    static public function is_XmlDocument($obj) {
        return is_object($obj) ? get_class($obj) == "Amfphp_Core_Types_XmlDocument" : false;
    }
